                  ...
                  <tbody>
                    @foreach ($brands as $brand)
                      <tr>
                        ...
                        <td>
  <form action="{{ route('brand.changeEtat', $brand->id) }}" method="GET" style="display:inline;">
    <div class="form-check form-switch">
      <input class="form-check-input" type="checkbox" name="etat" role="switch" onchange="this.form.submit()" {{ $brand->etat == 1 ? 'checked' : '' }}>
      <label class="form-check-label">
        {{ $brand->etat == 1 ? 'Activer' : 'Désactiver' }}
      </label>
    </div>
  </form>
</td>
